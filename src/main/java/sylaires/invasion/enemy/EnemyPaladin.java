...
public class EnemyPaladin extends EntityZombie implements IBasicEnemy {
	...
	public EnemyPaladin(org.bukkit.World w, int wave) {
	...
	public HashMap<ItemStack, Integer> getDrops() {
		...
		ItemStackUtil.addLoreToItem(flesh, ChatColor.GRAY + "Common Item");
		ItemStackUtil.addLoreToItem(flesh, ChatColor.YELLOW + "Can be transmuted into tallow at the Crucible");
		drops.put(flesh, 15);
		return drops;
	}
