...
public class EnemyWhiteWalker extends EntitySkeleton implements IBasicEnemy {
	...
	public EnemyWhiteWalker(org.bukkit.World w, int wave) {
        ...
        if(wave < 30) {
            ...
            ItemStackUtil.dyeLeather(i, Color.AQUA);
            ItemStackUtil.addEnchantment(i, Enchantment.ARROW_DAMAGE, 1);
            //Legs
            ItemStack leg = new ItemStack(Material.LEATHER_LEGGINGS);
            ItemStackUtil.dyeLeather(leg, Color.WHITE);
            ...
            //Wand
            ItemStack wand = new ItemStack(Material.IRON_SWORD);
            ...
            this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.65);
            this.persistent = true;
            this.getAttributeInstance(GenericAttributes.ATTACK_DAMAGE).setValue(0.8*(wave/2));
            this.getAttributeInstance(GenericAttributes.FOLLOW_RANGE).setValue(256);
        }
